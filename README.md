...
![Lista de DAGs](evidencias/airflow_dags_list.png.png)
...
![Grid data_collection](evidencias/airflow_data_collection_grid.png.png)
...
![model_training details](evidencias/airflow_model_training_details.png.png)
...
![model_training tasks](evidencias/airflow_model_training_tasks.png.png)
...
![MinIO models](evidencias/minio_models.png.png)
...
![PostgreSQL row counts](evidencias/postgresql_row_counts.png.png)
...
![Inference API predict](evidencias/inference_api_predict.png.png)
